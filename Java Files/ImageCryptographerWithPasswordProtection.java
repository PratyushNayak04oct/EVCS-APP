...
public class ImageCryptographerWithPasswordProtection {
    ...
    public static void main(String[] args) {
        try {
            ...
            String password = "yourSecurePassword123"; // This should be communicated securely to the receiver
            System.out.println("Adding password protection...");
            protectWithPassword(decryptedImage, password, "protected_decrypted.png");
